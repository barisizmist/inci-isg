    ...
    <section className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-gray-600 mt-3">10+ yıllık deneyim, mevzuat bilgisi ve proaktif yaklaşımla işyerlerinizin güvenliğini sağlamlaştırıyoruz.</p>
        </div>
        <div className="mt-12">
          <ul className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
            {expertise.map((item, idx) => (
              <li key={idx}>
                ...
                <div className="mt-2">
                  <h4 className="text-gray-700 font-semibold sm:text-lg dark:text-gray-100">{item.title}</h4>
